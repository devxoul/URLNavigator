...
For full documentation, see [URLNavigator Class Reference](http://cocoadocs.org/docsets/URLNavigator/0.4.1/Classes/URLNavigator.html).
...
- **For iOS 8+ projects** with [CocoaPods](https://cocoapods.org):
    ...
    ```ruby
    pod 'URLNavigator', '~> 0.4'
    ```

- **For iOS 8+ projects** with [Carthage](https://github.com/Carthage/Carthage):

    ```
    github "devxoul/URLNavigator" ~> 0.4
    ```

- **For iOS 7 projects** with [CocoaSeeds](https://github.com/devxoul/CocoaSeeds):

    ```ruby
    github 'devxoul/URLNavigator', '0.4.1', :files => 'Sources/*.swift'
    ```
...
- **Using [Swift Package Manager](https://swift.org/package-manager)**:
    ...
    let package = Package(
        name: "MyAwesomeApp",
        dependencies: [
            .Package(url: "https://github.com/devxoul/URLNavigator", "0.4.1"),
        ]
    )
    ```
