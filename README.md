...
For full documentation, see [URLNavigator Class Reference](http://cocoadocs.org/docsets/URLNavigator/1.1.0/Classes/URLNavigator.html).
...
- **For iOS 7 projects** with [CocoaSeeds](https://github.com/devxoul/CocoaSeeds):
    ...
    ```ruby
    github 'devxoul/URLNavigator', '1.1.0', :files => 'Sources/*.swift'
    ```
...
- **Using [Swift Package Manager](https://swift.org/package-manager)**:
    ...
    let package = Package(
      name: "MyAwesomeApp",
      dependencies: [
        .Package(url: "https://github.com/devxoul/URLNavigator", "1.1.0"),
      ]
    )
    ```
